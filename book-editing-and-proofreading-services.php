                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser1">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">We bring a wealth of editing and book proofreading services to the
                                table with our literary professionals specializing in multiple genres. </p>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser4">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">We take our time to listen to your instructions, formulate a
                                schematic outline, and complete the project within the estimated time promised.</p>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser2">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">
                                Effective client communication is crucial, and we offer a bespoke service to walk you
