<?php include 'partials/header.php'; ?>
    ...
    <!-- banner-start -->
    <section id="banner" class="banneroad01 portfolio for-mobile-ress">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-7">
    ...
    <section id="sample">
        <div class="container">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="sample-txt">
                            ...
                            <p>We are proud to showcase our work that reflects our continued efforts on every project.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <!-- portfolio -->
            <div class="sample-tab exrtacss">
                <div align="center">

                </div>
                <br>

                <div id="tab1" class="tab-pane active show text-center">
                    <div class="">
                ...
                <div class="col-md-8 cta-b-div p0">
                    <div class="con-cta-btn-div">
                        ...
                        <div class="col-lg col-b-2">
                            <p>Make a Call</p>
                            <a href="tel:+19292245924" class="con-cta-btn ct-b2">(551) 290-8897</a>
                        </div>
                        <div class="col-lg p0 col-b-3">
                            <p>Send us Email</p>
                            <a href="cdn-cgi/l/email-protection.html#0b7a7e6e79724b65727b7e69676278636e7978256864" class="con-cta-btn ct-b3"><span class="__cf_email__" data-cfemail="2b5a5e4e59526b45525b5e49474258434e5958054844">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </div>
            </div>
