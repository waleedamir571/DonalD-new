                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="bnr-txt btn-tx-cp">
                                <h4>Write for The Digital World Without Any Limits</h4>
                                <h2>Affordable Ebook Writing Services</h2>
                                <p>Transform your ideas into a captivating e-book with our premium quality ebook writing services. Our skilled writers specialize in crafting a tailor-made masterpiece that resonates with your target audience. Enter the digital era with a bang, and let us help you make your mark in the world of literature.</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="inner-txt-p">
                        <p>With our personalized approach to e-book creation, we will transform your basic ideas into a masterpiece that stands the test of time and make your readers in awe with your work. </p>
                        <p>Our ebook writers aim to help you build an authentic connection with your audience, so you can share your message without any restrictions. So why wait? </p>
                    </div>
                    <br>
                    <div class="cta-btn">
                ...
                <div class="col-md-12 write-main-div">
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser1">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="text-center">Our experts can take you to new heights! With their extensive knowledge and experience in multiple genres, they can craft exceptional content that will leave your readers spellbound. Whether you are looking for a creative or a business eBook writer, we have the team to deliver you the solution. </p>
                    ...
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser4">
                            ...
                            <div class="ser-box-txt">
                                <h3>Individually Tailored Services </h3>
                                <p>After careful consultation, we assign an expert specializing in your desired genre and work with you to create a personalized hierarchical outline and timely delivery.</p>
                    ...
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser2">
                            ...
                            <div class="ser-box-txt">
                                <h3>Impeccable Client Communication </h3>
                                <p>Every client and every project is unique. Our goal is to provide personalized and honest communication to deliver beyond your expectations.</p>
                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="sample-txt">
                            <h2><b>Our Enthralling Portfolio</b></h2>
                            <p>We are proud to showcase our work that reflects our commitment and hard work. If you are a a true ebook readers, you’d love to explore these. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row faq-tab-div2">
                    ...
                    <div class="col-12 col-xl-11 border-radius-20" style="background-size: cover !important; background:url('childrens-book/img/fiction/service1.jpg');">
                        <div class="row py-5 align-items-center">
                            <div class="order-2 order-md-1 col-md-6 text-white pr-md-0 pl-md-5 text-center text-md-left">
                                <h3 class="h2Heading">Extensive Research and Draft Outline</h3>
                                <p class="font-14">Our  ebook ghostwriter services start with thorough research outline creation, ensuring the content is aligned with your target audience and goals.</p>
                ...
                <div class="row mb-5">
                    <div class="col-12 col-xl-11 border-radius-20" style="background-size: cover !important; background:url('childrens-book/img/fiction/service1.jpg');">
                        <div class="row py-5 align-items-center">
                            <div class="order-2 order-md-1 col-md-6 text-white pr-md-0 pl-md-5 text-center text-md-left">
                                <h3 class="h2Heading">Reviewing, Editing, and Proofreading</h3>
                                <p class="font-14">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-12 col-xl-11 border-radius-20" style="background-size: cover !important; background:url('childrens-book/img/fiction/web-development-service.jpg');">
                        <div class="row py-5 align-items-center">
                            <div class="order-2 order-md-2 col-md-6 text-white text-center text-md-left" style="margin-left: -40px;">
                                <h3 class="h2Heading">Formatting, Designing, and Typesetting</h3>
                                <p class="font-14">
                ...
                <div class="row mb-5">
                    <div class="col-12 col-xl-11 border-radius-20" style="background-size: cover !important; background:url('childrens-book/img/fiction/service1.jpg');">
                        <div class="row py-5 align-items-center">
                            ...
                            <div class="order-1 order-md-2 col-md-6 align-self-center pt-3 pt-md-0 pb-md-0">
                                <img src="nypublishers/assets/images/1155.png" alt="professional writer service" class="border-radius-20 img-non-fliud">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-1">
