...
function nameEmailPhoneMessageForm($data, $connection)
{
    ...
    $userBody = "
        <p>Dear <b>{$name},</b></p>
        <p>Thank you for reaching out to Donalds Book Publishing! Our team has received your query and is working on it. Expect to hear back from us within 24 hours. For quick answers, you might find our page helpful.</p>
