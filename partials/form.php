    ...
    <section class="custom-ban-form">
        <div class="form-banner bannnform">
            <h3 style="font-size: 22px;padding-bottom: 10px;text-align: center;">
                <strong>Connect With Our <br> Publishing Specialists</strong>
            </h3>
            <p class="call-details text-center mt-2 mb-2">
                Schedule a free consultation by sharing your details below or calling us directly.
            </p>
            <p
                        ...
                        <div class="ban-form">
                            <form action="backend/action/action.php" method="POST" class="cmxform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="fldset">
                                            <input onkeypress="return isNumberKey(event);" id="phone-country"
                                                name="phone" type="text" placeholder="Phone Number *" maxlength="10"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
